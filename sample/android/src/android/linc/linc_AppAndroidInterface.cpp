...
namespace android {
    ...
    ::cpp::Pointer<void> AppAndroidInterface_sharedInterface(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_) {
        jobject return_jni_ = ::bindhx::jni::GetJNIEnv()->CallStaticObjectMethod((jclass) class_.ptr, (jmethodID) method_.ptr);
        ::cpp::Pointer<void> return_hxcpp_ = return_jni_ != NULL ? ::cpp::Pointer<void>(::bindhx::jni::GetJNIEnv()->NewGlobalRef(return_jni_)) : null();
    ...
    void AppAndroidInterface_hello(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> instance_, ::String name, ::Dynamic done) {
        jstring name_jni_ = ::bindhx::jni::HxcppToJString(name);
        jstring done_jni_ = ::bindhx::jni::HObjectToJString(done);
        ::bindhx::jni::GetJNIEnv()->CallStaticVoidMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) instance_.ptr, name_jni_, done_jni_);
    }
    ...
    ::String AppAndroidInterface_androidVersionString(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> instance_) {
        jstring return_jni_ = (jstring) ::bindhx::jni::GetJNIEnv()->CallStaticObjectMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) instance_.ptr);
        ::String return_hxcpp_ = ::bindhx::jni::JStringToHxcpp(return_jni_);
        return return_hxcpp_;
    }
    ...
    int AppAndroidInterface_androidVersionNumber(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> instance_) {
        jint return_jni_ = ::bindhx::jni::GetJNIEnv()->CallStaticIntMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) instance_.ptr);
    ...
    ::String AppAndroidInterface_testTypes(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> instance_, int aBool, int anInt, double aFloat, ::String aList, ::String aMap) {
        ...
        jstring aList_jni_ = ::bindhx::jni::HxcppToJString(aList);
        jstring aMap_jni_ = ::bindhx::jni::HxcppToJString(aMap);
        jstring return_jni_ = (jstring) ::bindhx::jni::GetJNIEnv()->CallStaticObjectMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) instance_.ptr, aBool_jni_, anInt_jni_, aFloat_jni_, aList_jni_, aMap_jni_);
        ::String return_hxcpp_ = ::bindhx::jni::JStringToHxcpp(return_jni_);
        return return_hxcpp_;
    }
    ...
    ::Dynamic AppAndroidInterface_getOnPause(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> instance_) {
        jobject return_jni_ = ::bindhx::jni::GetJNIEnv()->CallStaticObjectMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) instance_.ptr);
        ::Dynamic return_hxcpp_ = return_jni_ != NULL ? ::cpp::Pointer<void>(::bindhx::jni::GetJNIEnv()->NewGlobalRef(return_jni_)) : null();
        return return_hxcpp_;
    }
    ...
    void AppAndroidInterface_setOnPause(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> instance_, ::Dynamic onPause) {
        jstring onPause_jni_ = ::bindhx::jni::HObjectToJString(onPause);
        ::bindhx::jni::GetJNIEnv()->CallStaticVoidMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) instance_.ptr, onPause_jni_);
    }
    ...
    void AppAndroidInterface_setOnResume(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> instance_, ::Dynamic onResume) {
        jstring onResume_jni_ = ::bindhx::jni::HObjectToJString(onResume);
        ::bindhx::jni::GetJNIEnv()->CallStaticVoidMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) instance_.ptr, onResume_jni_);
    }
    ...
    void AppAndroidInterface_setLastName(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> instance_, ::String lastName) {
        jstring lastName_jni_ = ::bindhx::jni::HxcppToJString(lastName);
        ::bindhx::jni::GetJNIEnv()->CallStaticVoidMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) instance_.ptr, lastName_jni_);
    }

    void AppAndroidInterface_callJ_Void(::cpp::Pointer<void> class_, ::cpp::Pointer<void> method_, ::cpp::Pointer<void> callback_) {
        ::bindhx::jni::GetJNIEnv()->CallStaticVoidMethod((jclass) class_.ptr, (jmethodID) method_.ptr, (jobject) callback_.ptr);
    }
...
extern "C" {
    ...
    JNIEXPORT void Java_yourcompany_androidsample_bind_1AppAndroidInterface_callN_1Void(JNIEnv *env, jclass clazz, jstring address) {
        ...
        ::Dynamic func_hobject_ = ::bindhx::jni::JStringToHObject(address);
        ::Dynamic func_unwrapped_ = ::bindhx::java::HObject_obj::unwrap(func_hobject_);
